...
import NewZoomingVideo from "@/app/components/Landing/NewZoomingVideo/NewZoomingVideo";
import ProjectsGrid from "@/app/components/Landing/ProjectsGrid/ProjectsGrid";
import CTASection from "@/app/components/Landing/CTASection/CTASection";
import StartSection from "@/app/components/Landing/StartSection/StartSection";
...
export default function Home() {
  ...
  useEffect(() => {
    document.title =
      "Integra Magna | Branding, Strategy, and UX UI Design Agency"; // Set the document title
  }, []);
  ...
  return (
    <>
      ...
      >
        <a
          href="https://www.awwwards.com/sites/integra-magna"
          target="_blank"
          rel="noreferrer"
        >
          <svg
