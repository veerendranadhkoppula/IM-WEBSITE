...
export default function Home() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const landingHeroText = document.querySelectorAll(
  ...
  useGSAP(
    () => {
      ...
      const splitText1 = new SplitType(heroTexts.current[0], {
        types: "chars,w",
        tagName: "span",
      });
      const splitText2 = new SplitType(heroTexts.current[1], {
        types: "chars",
        tagName: "span",
      });
      const splitText3 = new SplitType(heroTexts.current[2], {
        types: "chars",
        tagName: "span",
      });
      ...
      const ctx = gsap.context(() => {
        heroTexts.current.forEach((heroText, index) => {
          ...
          if (heroText) {
            gsap.fromTo(
              heroText.querySelectorAll(".word"),
              {
                yPercent: 100,
      ...
      <section className={landingStyles.Hero_section}>
        <div className={landingStyles.header_hero}>
          ...
          >
            ...
            <span
              className={`${landingStyles.spectrum}`}
              ref={(el) => (heroTexts.current[0] = el)}
            >
              Spectrum
            </span>
            <span
              className={`${landingStyles.of_Diverse} `}
            ...
            <span
              className={`${landingStyles.Perspectives} `}
              ref={(el) => (heroTexts.current[2] = el)}
            >
              Perspectives
            </span>
          </h1>
